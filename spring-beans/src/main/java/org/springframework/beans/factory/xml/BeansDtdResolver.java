 ...
 *
 * org.springframework.beans.factory.xm.BeansDtdResolver ：实现 EntityResolver 接口，
...
public class BeansDtdResolver implements EntityResolver {
	 ...
	 *
	 * 加载 DTD 类型的 BeansDtdResolver#resolveEntity(...) 过程，只是对 systemId 进行了简单的校验（从最后一个 / 开始，内容中是否包含 spring-beans），
